...
Deployed Application (**Kudos Board**): [Kudos Board Deployed Site](https://kudos-board-frontend-b8iu.onrender.com/)
...
I felt that the labs did prepare me to complete the assignment. However, more teaching on how to query the website for filtering and searching would have been nice, but just reading the docs was sufficient.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would improve the way I did error handling. I was more focused getting the MVP first before I created a better error handling system.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

The project demo went well. I was able to show everything that I wanted to show.
...
Shout out to Matthew the instructor for being super helpful.
